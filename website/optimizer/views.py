...
def create_optimizer(request):
    if request.method == 'POST':
        ...
        html_table = df.to_html(index=False, justify='left', escape=False, table_id='slateData',
                                classes=[
                                    'table w3-table-all table-bordered table-striped table-hover table-responsive table-sm searchable sortable data-search="true" tablesorter tablesorter-default container-fluid'])
        return render(request, 'optimizer/optimizer.html',
