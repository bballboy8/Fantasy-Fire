    ...
    if request.method == 'POST':
        ...
        if form2.is_valid() and 'change_slate' in request.POST:
            ...
            html_table = df.to_html(index=False, justify='left', escape=False, table_id='slateData',
                                    classes=[
                                        'table table-bordered sortable table-striped table-hover table-responsive table-sm, container-fluid'])
        ...
        html_table = df.to_html(index=False, justify='left', escape=False, table_id='slateData',
                                classes=[
                                    'table sortable table-bordered table-striped table-hover table-responsive table-sm searchable container-fluid'])
        return render(request, 'optimizer/optimizer.html',
